...
const DiagnosticsSchema = Type.Object({
  ...
  raw_surplus_w: Type.Number(),
  byd_discharge_w: Type.Number(),
  production_cap_w: Type.Number(),
  charge_blocked_by_byd: Type.Boolean(),
      ...
      return {
        ...
        diagnostics: diagnostics
          ? {
              ...
              raw_surplus_w: diagnostics.rawSurplusW,
              byd_discharge_w: diagnostics.bydDischargeW,
              production_cap_w: diagnostics.productionCapW,
              charge_blocked_by_byd: diagnostics.chargeBlockedByByd,
